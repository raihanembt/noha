...
<html>
    ...
    <div class="heading text-center font-bold text-3xl m-5 text-red-500">recherche livre</div>
    <div class="heading text-center text-l m-5 text-black-400">Veuillez remplir tous les champs</div>
<style>
  body {background:white !important;}
</style>
  
    <form action="traitemmentRecherche.php" method="POST">
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
            ...
            <input  class="btn border border-red-500 p-1 px-4 font-semibold cursor-pointer text-gray-100 ml-2 bg-red-500 hover:bg-red-600" type="submit" value="rechercher">
