        ...
        <div class="grid place-items-center mx-2 my-20 sm:my-auto" x-data="{ showPass: true }">
            <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12
                ...
                <form class="space-y-5" action="verification.php" method="POST">
                    <div>
                        <input id="nom" type="text" name="nom" class="block w-full py-3 px-3 mt-2
                            text-gray-800 appearance-none
                            border-2 border-gray-100
                            focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" placeholder="nom"/>
                    </div>

                    <div class="relative w-full">
                        <input :type="showPass ? 'password' : 'text'" id="password" name="modepass" class="block w-full py-3 px-3 mt-2 mb-4
                            text-gray-800 appearance-none
                            border-2 border-gray-100
